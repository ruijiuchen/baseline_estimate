...
'''test for PLS method'''
# est for linear
linear_AsLSS = nonparams_base_est_linear.pls(method='AsLSS', l=1e7, p=0.001, niter=10)
...
linear_BarPLS = nonparams_base_est_linear.pls(method='BarPLS', l=4e9, ratio=1e-6)
linear_AsLSS_R_sqr = r_sqr_non_params(sim_bg_linear, linear_AsLSS)
...
linear_BarPLS_R_sqr = r_sqr_non_params(sim_bg_linear, linear_BarPLS)

# est for lorentz
lorentz_AsLSS = nonparams_base_est_lorentz.pls(method='AsLSS', l=1e7, p=0.001, niter=10)
...
lorentz_BarPLS = nonparams_base_est_lorentz.pls(method='BarPLS', l=1e9, ratio=1e-6)
lorentz_AsLSS_R_sqr = r_sqr_non_params(sim_bg_lorentz, lorentz_AsLSS)
...
lorentz_BarPLS_R_sqr = r_sqr_non_params(sim_bg_lorentz, lorentz_BarPLS)
...
ax[0,0].plot(sim_x, linear_AsLSS, linestyle=(0,(1,1)), color='green', label="{:}, $R^2$={:.4f}".format('AsLSS', linear_AsLSS_R_sqr))
...
ax[0,0].plot(sim_x, linear_BarPLS, linestyle=(0,(3,1,1,1)), color='darkorange', label="{:}, $R^2={:.4f}$".format('BarPLS', linear_BarPLS_R_sqr))
...
ax[0,1].plot(sim_x, lorentz_AsLSS, linestyle=(0,(1,1)), color='green', label="{:}, $R^2={:.4f}$".format('AsLSS', lorentz_AsLSS_R_sqr))
...
ax[0,1].plot(sim_x, lorentz_BarPLS, linestyle=(0,(3,1,1,1)), color='darkorange', label="{:}, $R^2={:.4f}$".format('BarPLS', lorentz_BarPLS_R_sqr))
...
ax[1,0].plot(sim_x, linear_AsLSS - sim_bg_linear, linestyle=(0,(1,1)), color='green', label="{:}, $R^2_{{bas}}$={:.4f}".format('AsLSS', np.std(sim_bg_linear - linear_AsLSS)))
...
ax[1,0].plot(sim_x, linear_BarPLS - sim_bg_linear, linestyle=(0,(3,1,1,1)), color='darkorange', label="{:}, $R^2_{{bas}}={:.4f}$".format('BarPLS', np.std(sim_bg_linear - linear_BarPLS)))
...
ax[1,1].plot(sim_x, lorentz_AsLSS - sim_bg_lorentz, linestyle=(0,(1,1)), color='green', label="{:}, $R^2_{{bas}}={:.4f}$".format('AsLSS', np.std(sim_bg_lorentz - lorentz_AsLSS)))
...
ax[1,1].plot(sim_x, lorentz_BarPLS - sim_bg_lorentz, linestyle=(0,(3,1,1,1)), color='darkorange', label="{:}, $R^2_{{bas}}={:.4f}$".format('BarPLS', np.std(sim_bg_lorentz - lorentz_BarPLS)))
